...
import com.padel.apirest.response.InscricaoResponse;
...
public class InscricaoResource {
	...
	public List<InscricaoResponse> listaInscricao(){ 
		List<Inscricao> inscricaoList = inscricaoRepository.findAll();
		ArrayList<InscricaoResponse> inscricaoResponseList = new ArrayList<>();
